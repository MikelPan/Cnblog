...
app = Flask(__name__)
url = 'https://oapi.dingtalk.com/robot/send?access_token=859fe7562a332ec1d0a1b7385da590baa726a0b59c9311a68d7bf32e5b64d621xxx' 

def get_timestamp_sign():
    timestamp = long(round(time.time() * 1000))
    secret = 'SEC5d4464c3b48f46352d7d0ec92a1f7b674c11910acefc4bf2b332d6a8a5c6'
...
def get_dingtalk_content(data):
    ...
    for item in data:
        if item['status'] == 'firing':
            ...
            warning_host = '告警集群：' + item['lables']['env'] + '\n'
