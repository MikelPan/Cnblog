...
```console
$ helm install <helm-repo>/prometheus-operator
```
...
```console
$ helm install --name my-release <helm-repo>/prometheus-operator
```
...
```console
$ helm install --name my-release <helm-repo>/prometheus-operator --set prometheusOperator.createCustomResource=false
```
...
```console
$ helm install --name my-release <helm-repo>/prometheus-operator --set prometheusOperator.enabled=true
```
...
```console
$ helm install --name my-release <helm-repo>/prometheus-operator -f values1.yaml,values2.yaml
```
